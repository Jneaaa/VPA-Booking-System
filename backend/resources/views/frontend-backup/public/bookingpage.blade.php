  ...
  <head>
    ...
    <style>
      ...
      .form-section-card {
        background: white;
        padding: 20px;
        border: 1px solid #ddd; /* Replace shadow with solid stroke */
      ...
      .facility-card,
      .equipment-card {
        position: relative; /* Enable positioning for the trash bin */
      ...
      .equipment-card .btn-outline-danger {
        position: absolute;
        top: 10px;
        right: 10px; /* Move trash bin to top-right */
      ...
      .facility-card img,
      .equipment-card img {
        width: 120px; /* Ensure consistent image size */
        height: 120px;
        object-fit: cover;
        border-radius: 0; /* Remove rounded corners from images */
        margin-right: 15px;
      }
      ...
      .equipment-card .equipment-details {
        flex-grow: 1;
        margin-right: 30px; /* Further reduce right margin */
      }
    </style>
  </head>
...
<nav class="navbar navbar-expand-lg main-navbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <a href="bookingpage" class="btn btn-book-now ms-lg-3 active">Book Now</a>
        </div>
    </div>
</nav>
      ...
      <div class="row">
        ...
        <div class="col-md-6 d-flex flex-column">
          <div class="form-section-card flex-grow-1">
            ...
            <div class="row">
              <div class="col-md-6">
                <label for="startDateField" class="form-label"
                  >Start Date</label
                >
                <input
                  type="date"
              ...
              <div class="col-md-6">
                <label for="startTimeField" class="form-label"
                  >Start Time</label
                >
                <select
                  id="startTimeField"
                  class="form-select mb-2"
                  onchange="adjustEndTime()"
                >
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <textarea
                  class="form-control mb-2"
                  rows="2"
                  placeholder="Write a brief description of the purpose of your requisition."
                ></textarea>
              </div>
              ...
              <div class="col-md-6">
                <label class="form-label mt-3"
                  >Please attach formal letter.</label
                >
