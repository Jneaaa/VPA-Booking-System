                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="mb-4 h-100">
                                            ...
                                            <div class="dropzone border p-4 text-center h-100" id="facilityPhotosDropzone"
                                                style="cursor: pointer;">
                                                <i class="bi bi-images fs-1 text-muted"></i>
                                                <p class="mt-2">Drag & drop facility photos here or click to browse</p>
                                                <input type="file" id="facilityPhotos" name="images[]" class="d-none"
                                                    multiple accept="image/*">
                                            </div>
                                            <div id="photosPreview" class="d-flex flex-wrap gap-2 mt-3"></div>
                                            <small class="text-muted">Upload at least one photo of the facility (max 5
                                                photos)</small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="facilityName"
                                                        name="facility_name" placeholder="Enter facility name" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
    ...
    @endforeach
                                            ...
                                            <div class="row mb-4" id="roomDetailsContainer" style="display: none;">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="floorLevel"
                                                        name="floor_level" min="1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-8 mb-3 position-relative">
                                                    ...
                                                    <textarea class="form-control" id="locationNote" name="location_note"
                                                        rows="2" maxlength="80"
                                                        placeholder="Brief description of where the facility is located."
                                                        required></textarea>
                                                    <small class="text-muted position-absolute bottom-0 end-0 me-4 mb-1"
                                                        id="locationNoteWordCount">0/80 characters</small>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="capacity" class="form-label">Capacity (max people) *</label>
                                                    <input type="number" class="form-control" id="capacity" name="capacity"
                                                        min="1" placeholder="Maximum capacity" required>
                                                </div>
                                            </div>
                                            <!-- Department & Flags Section -->
                                            <div class="row mb-4">
                                                <div class="col-md-4 mb-3">
                                                    <label for="department_id" class="form-label">Owning Department
                                                        *</label>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="internal_fee"
                                                        name="internal_fee" min="0" step="0.01" value="0" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="external_fee" class="form-label">External Fee (₱) *</label>
                                                    <input type="number" class="form-control" id="external_fee"
                                                        name="external_fee" min="0" step="0.01" value="0" required>
                                                </div>
                                            </div>
                                            <!-- Rate Type -->
                                            <div class="row mb-4">
                ...
                <script>
                    ...
                    async function loadCategories() {
                        try {
                            ...
                            // Update subcategory map for the existing event listener
                            window.subcategoryMap = {};
                            categories.forEach(category => {
                                window.subcategoryMap[category.category_id] = category.subcategories;
                            });
...
// Update the subcategoryMap creation
