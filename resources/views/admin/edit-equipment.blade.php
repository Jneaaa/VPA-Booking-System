                    ...
                    downloadBarcodeBtn.addEventListener('click', function() {
                        ...
                        link.click();
                                    ...
                                    async function fetchDropdownData(equipment) {
                                        try {
                                            const token = localStorage.getItem('adminToken');
                                            console.log('Equipment data for dropdowns:', equipment); // Debug log
                                    ...
                                    function populateDropdown(elementId, data, selectedValue = null, idKey, nameKey) {
                                        ...
                                        if (selectedValue !== null && dropdown.value !== selectedValue.toString()) {
                                            console.warn(`Could not find selected value ${selectedValue} in dropdown ${elementId}. Available values:`, data.map(item => item[idKey]));
                                        } else if (selectedValue !== null) {
                                            console.log(`Successfully selected value ${selectedValue} in dropdown ${elementId}`);
                                        }
                                    }
