                    ...
                    <div class="d-flex gap-2">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="eventTypeDropdown">
                                <li><button class="dropdown-item" data-filter="facility"><i
                                            class="bi bi-door-open me-2"></i>Facility
                                        Rentals</button></li>
                                <li><button class="dropdown-item" data-filter="equipment"><i
                                            class="bi bi-tools me-2"></i>Equipment
                                        Rentals</button></li>
                                <li><button class="dropdown-item" data-filter="university"><i
                                            class="bi bi-building me-2"></i>University
                                        Events</button></li>
                                <li><button class="dropdown-item" data-filter="external"><i
                                            class="bi bi-globe me-2"></i>External
                                        Events</button></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><button class="dropdown-item" data-filter="all"><i class="bi bi-eye me-2"></i>Show
                                        All</button></li>
                            </ul>
                        </div>
            ...
            <section class="mt-5">
                ...
                <div id="systemLog" class="border rounded p-3 log-container">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <strong>John Doe</strong> (Head Admin) deleted a facility: Old Gymnasium on <em>March 5,
                                2024</em>.
                        </li>
                    </ul>
                </div>
