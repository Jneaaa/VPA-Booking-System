                ...
                <div class="card stat-card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <i class="bi bi-file-earmark-text fs-1 text-primary" style="color: gray !important;"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card stat-card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <i class="bi bi-check-circle fs-1 text-success" style="color: gray !important;"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card stat-card h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <i class="bi bi-hourglass-split fs-1 text-warning" style="color: gray !important;"></i>
                        </div>
                    </div>
                </div>
            </div>
