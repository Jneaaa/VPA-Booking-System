                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="details-section">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-6">
                                                    <label for="storageLocation" class="form-label fw-bold">
                                                        Storage Location *
                                                    </label>
                                                    <input type="text" class="form-control" id="storageLocation" required>
                                                </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-3">
                                                    <label for="rentalFee" class="form-label fw-bold">Internal Fee
                                                        (₱) *</label>
                                                ...
                                                <div class="col-md-3">
                                                    <label for="companyFee" class="form-label fw-bold">External Fee
                                                        (₱) *</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text">₱</span>
                ...
                <div class="modal-body">
                    <form id="itemForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Enter barcode" readonly>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (addItemBtn) {
                ...
                // Function to generate a valid barcode
                function generateValidBarcode() {
                    const timestamp = Date.now();
                    const randomDigits = Math.floor(Math.random() * 10000).toString().padStart(4, '0');
                    return `EQ-${timestamp}-${randomDigits}`;
                }

                // Function to validate barcode format
                function isValidBarcode(barcode) {
                    return barcode && barcode.startsWith('EQ-') && barcode.length > 10;
                }
                ...
                addItemBtn.addEventListener('click', () => {
                    ...
                    // Auto-generate a barcode when opening the modal
                ...
                if (saveItemBtn) {
                    saveItemBtn.addEventListener('click', async function () {
                        ...
                        if (!isValidBarcode(barcode)) {
                            showToast('Please generate a valid barcode', 'error');
                            return;
                        }
            ...
            document.getElementById('addEquipmentForm').addEventListener('submit', async function (e) {
                ...
                try {
                    ...
                    const formData = {
                        ...
                        internal_fee: document.getElementById('rentalFee').value, // FIXED: Changed to match your database
                        external_fee: document.getElementById('companyFee').value, // FIXED: Changed to match your database
