                ...
                <div class="container-fluid">
                    ...
                    <div id="facilityContainer" class="row g-3">
                        ...
                        <div class="col-md-4 facility-card" data-status="available" data-department="CBA"
                            data-category="Sports" data-title="Volleyball Court">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="card-text mb-3">Indoor volleyball court located inside the University Gym,
                                            featuring a standard playing surface, regulation net, and ample space for
                                            training, classes, or recreational games. Bleacher seating available for
                                            spectators.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex"
                                            onclick="window.location.href='manage-facility.html';">Manage</button>
                        ...
                        <div class="col-md-4 facility-card" data-status="reserved" data-department="CCS"
                            data-category="Rooms" data-title="Conference Room (2nd Floor)">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="card-text mb-3">A formal meeting space equipped with tables, chairs,
                                            projector, and whiteboard. Ideal for seminars, presentations, academic
                                            discussions, and organizational meetings. Located in Henrilous Library, 2nd
                                            Floor.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                        ...
                        <div class="col-md-4 facility-card" data-status="unavailable" data-department="CAS"
                            data-category="Buildings" data-title="University Church">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="card-text mb-3">A spacious, multi-purpose venue within campus grounds used
                                            for religious services, ceremonies, and university events. Equipped with audio
                                            systems, seating, and a peaceful atmosphere suitable for gatherings and
                                            reflections.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                        ...
                        <!-- Basketball Court -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CBA"
                            data-category="Sports" data-title="Basketball Court">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Outdoor basketball court with hardwood flooring,
                                            regulation hoops, and scoreboard. Suitable for official games and practice
                                            sessions. Located near the University Gymnasium.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <div class="col-md-4 facility-card" data-status="available" data-department="CCS"
                            data-category="Rooms" data-title="Computer Lab 1">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Modern computer laboratory equipped with 30
                                            high-performance workstations, projector, and whiteboard. Ideal for programming
                                            classes, research, and workshops. Located in CCS Building, Room 201.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <div class="col-md-4 facility-card" data-status="reserved" data-department="CAS"
                            data-category="Rooms" data-title="Audio Visual Room">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-reserved">Reserved</p>
                                        <p class="card-text mb-3">Specialized room with high-quality audio and video
                                            equipment, including projector, sound system, and theater-style seating. Perfect
                                            for film screenings, presentations, and multimedia classes. Capacity: 50
                                            persons.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                        ...
                        <!-- Tennis Court -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CBA"
                            data-category="Sports" data-title="Tennis Court">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Outdoor tennis court with synthetic grass surface and
                                            professional net. Available for classes, training, and recreational use.
                                            Equipment can be rented from the Sports Office.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Faculty Lounge -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CCS"
                            data-category="Rooms" data-title="Faculty Lounge">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Comfortable lounge area for faculty members, equipped with
                                            sofas, tables, coffee machine, and refrigerator. Ideal for meetings, breaks, and
                                            informal discussions. Located on the 3rd floor of the CCS Building.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Science Laboratory -->
                        <div class="col-md-4 facility-card" data-status="unavailable" data-department="CAS"
                            data-category="Rooms" data-title="Science Laboratory">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-unavailable">Unavailable</p>
                                        <p class="card-text mb-3">Fully equipped science laboratory for chemistry and
                                            biology experiments. Contains fume hoods, microscopes, and all necessary
                                            equipment for undergraduate research and classes. Under maintenance until next
                                            week.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                        ...
                        <!-- Swimming Pool -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CBA"
                            data-category="Sports" data-title="Swimming Pool">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Olympic-sized swimming pool with 8 lanes, diving boards,
                                            and spectator seating. Used for physical education classes, swimming
                                            competitions, and recreational swimming. Lifeguard on duty during open hours.
                                        </p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                        ...
                        <!-- Library Study Room -->
                        <div class="col-md-4 facility-card" data-status="reserved" data-department="CCS"
                            data-category="Rooms" data-title="Library Study Room">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-reserved">Reserved</p>
                                        <p class="card-text mb-3">Quiet study room in the library with tables, chairs, and
                                            power outlets. Ideal for group study sessions or individual work. Capacity: 8
                                            persons. Reservations required during exam periods.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Amphitheater -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CAS"
                            data-category="Buildings" data-title="Amphitheater">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Open-air amphitheater with stone seating for 200 people.
                                            Used for outdoor performances, lectures, and special events. Equipped with basic
                                            sound system and lighting for evening events.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Music Room -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CBA"
                            data-category="Rooms" data-title="Music Room">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Soundproof room equipped with piano, music stands, and
                                            audio equipment. Used for music classes, choir practice, and individual
                                            rehearsals. Instruments available for checkout.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Lecture Hall A -->
                        <div class="col-md-4 facility-card" data-status="reserved" data-department="CCS"
                            data-category="Rooms" data-title="Lecture Hall A">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-reserved">Reserved</p>
                                        <p class="card-text mb-3">Large lecture hall with tiered seating for 120 students.
                                            Equipped with projector, sound system, and multiple whiteboards. Ideal for large
                                            classes, guest lectures, and departmental meetings.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
                        ...
                        <!-- Art Studio -->
                        <div class="col-md-4 facility-card" data-status="available" data-department="CAS"
                            data-category="Rooms" data-title="Art Studio">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div>
                                        ...
                                        <p class="status-available">Available</p>
                                        <p class="card-text mb-3">Bright studio space with north-facing windows, easels, and
                                            art supplies. Suitable for painting, drawing, and sculpture classes. Sink and
                                            storage cabinets available for student use.</p>
                                    </div>
                                    <div class="facility-actions mt-auto pt-3">
                                        <button class="btn btn-manage btn-flex">Manage</button>
                                        <button class="btn btn-outline-danger btn-delete">Delete</button>
