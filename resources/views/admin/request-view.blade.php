                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" id="confirmationModalBody">
                            <p>Are you sure you want to <span id="actionType"></span> this request? This action cannot
                                be undone.</p>
                            <div class="mb-3">
            ...
            <script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.8/index.global.min.js"></script>
                ...
                `;
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex align-items-center justify-content-center">
                            <p class="mb-0"><strong>Approvals:</strong> ${request.approval_info.approval_count}/3</p>
                        </div>
                        <div class="col-md-3 d-flex align-items-center justify-content-center">
                ...
                `;
                                    ...
                                    // Set up approve/reject button click handlers
