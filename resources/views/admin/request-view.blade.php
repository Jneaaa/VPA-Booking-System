...
<div class="container-fluid admin-container">
    ...
    <h5 class="card-title mb-0 d-flex align-items-center gap-2">
        ...
        <select class="form-select form-select-sm" id="statusDropdown" style="max-width: 150px;">
                ...
                `;
                        ...
                        async function fetchRequestDetails() {
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 d-flex align-items-center justify-content-center">
                                    <p class="mb-0"><strong>Approvals:</strong> ${request.approval_info.approval_count}</p>
                                </div>
                                <div class="col-md-2 d-flex align-items-center justify-content-center">
                                    <p class="mb-0"><strong>Rejections:</strong> ${request.approval_info.rejection_count}</p>
                                </div>
