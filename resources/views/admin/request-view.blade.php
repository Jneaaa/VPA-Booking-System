                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <label for="feeType" class="form-label">Select Fee Type</label>
                                    ...
                                    <label for="feeValue" class="form-label mt-3">Enter Value</label>
                                    <input type="number" id="feeValue" class="form-control"
                                        placeholder="Enter fee/discount amount">
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Cancel</button>
                                    <button type="button" id="saveFeeBtn" class="btn btn-primary">Add Fee</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            saveFeeBtn.addEventListener("click", function () {
                                ...
                                // --- NEW: Create the improved fee item display ---
