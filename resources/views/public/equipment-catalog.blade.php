            ...
            <div class="d-flex gap-2 filter-sort-dropdowns">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" id="statusFilterMenu">
                  ...
                  <li><a class="dropdown-item status-option" href="#" data-status="Under Maintenance">Under Maintenance</a></li>
...
@section('scripts')
  <script src="{{ asset('js/public/equipment-catalog.js') }}"></script>
@endsection
